...
lines(lowess(cecdat$MAP,cecdat$pH), lwd=1.5, col="red")
...
lines(lowess(cecdat$LSTD,cecdat$pH), lwd=1.5, col="red")
abline(h=round(CD,2), lwd=1.5, col="red")
plot(pH~PARA, cecdat, xlab = "Mean fAPAR (%)", ylab="Soil pH (Water)", xlim=c(0,100), cex.lab=1.3)
lines(lowess(cecdat$PARA,cecdat$pH), lwd=1.5, col="red")
abline(h=round(CD,2), lwd=1.5, col="red")
plot(pH~PARV, cecdat, xlab = "Variance fAPAR (%)", ylab="Soil pH (Water)", xlim=c(0,800), cex.lab=1.3)
lines(lowess(cecdat$PARV,cecdat$pH), lwd=1.5, col="red")
abline(h=round(CD,2), lwd=1.5, col="red")
